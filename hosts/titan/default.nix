...
# Bootloader.
  ...
  users.users.nmurray.shell = pkgs.fish;
  # Install firefox.
...
#  (pkgs.writeShellScriptBin "nix-usage" (builtins.readFile .../scripts/nix-usage.sh))
#  (pkgs.writeShellScriptBin "nix-nuclear" (builtins.readFile .../scripts/nix-nuclear.sh))
  neovim
  ghostty
  git
  wget
